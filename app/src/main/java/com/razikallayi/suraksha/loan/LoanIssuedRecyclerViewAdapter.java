...
public class LoanIssuedRecyclerViewAdapter
        extends RecyclerViewCursorAdapter<LoanIssuedRecyclerViewAdapter.ViewHolder> implements LoanIssuedFragment.OnItemClickListener {
    ...
    @Override
    public void onItemClick(View view, long loanIssueId) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(final Cursor cursor) {
            ...
            Log.d("FISH", "bindData: " + loanIssue.toString());
            Log.d("FISH", "bindData: " + Utility.formatAmountInRupees(context, loanIssue.getAmount()));

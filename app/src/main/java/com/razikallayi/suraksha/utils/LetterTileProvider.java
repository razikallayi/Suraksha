...
/**
 * Created by Razi Kallayi on 29-06-2016 12:32.
 */
...
//        mDefaultBitmap = BitmapFactory.decodeResource(res, android.R.drawable.sym_def_app_icon);
     ...
     * @param width The desired height of the tile
     * @return A {@link Bitmap} that contains a letter used in the English
     * alphabet or digit, if there is no letter or digit available, a
     * default image is shown instead
     */
    public Bitmap getLetterTile(String name, String key, int width) {
        ...
        mPaint.getTextBounds(name, 0, 1, mBounds);

        c.drawText(name, 0, 1, width / 2, width / 2
